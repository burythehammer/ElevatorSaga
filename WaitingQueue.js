        ...
        init: function(elevators, floors) {
            ...
            elevators.forEach(function(elevator, e){
                ...
                elevator.on("floor_button_pressed", function(floorNum){ // someone pressed a floor so add it to the queue
                    ...
                    floorWaitingQueue = removeFloorFromWaitingQueue(floorWaitingQueue, floorNum); // removes from waiting queue
                ...
                function findNextDestination(elevator){
                    ...
                    console.log('elevator' + e + ' got floor ' + destinationFloor + ' from the wait queue ');
                    ...
                    floorWaitingQueue = removeFloorFromWaitingQueue(floorWaitingQueue, destinationFloor); // removes from waiting queue           

                    console.log('Elevator ' + e + ' sent to floor ' + destinationFloor);
